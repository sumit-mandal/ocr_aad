...
@app.route('/')
def landing():
    return "This is landing page. <br> Use /index/aadhar/id for aadhar <br> use /index/pan/id for pan.<br> Use /video_feed/ for live video .<br> use /extract_data/ to extract the data from pan and aadhar."
